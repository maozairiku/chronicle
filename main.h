...
enum
{
	...
	MODE_GAME,				// ゲームマップ1(cavernas+village)画面
	MODE_GAME_MAP2,			// ゲームマップ2画面(mountain_road+mountain_hut)画面
	MODE_GAME_MAP3,			// ゲームマップ3(lakeside_mountain_road+lake)画面
	MODE_GAME_MAP4,			// ゲームマップ4(TE_lake_difference)画面
	MODE_END,
	MODE_OPTION,			// オプション画面
	MODE_RESULT,			// リザルト画面
	MODE_MAX
